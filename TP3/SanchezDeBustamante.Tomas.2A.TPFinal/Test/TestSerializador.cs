...
namespace Test
{
    ...
    public class TestSerializador
    {
        ...
        public void AgregarDuenios_RecibeTrue()
        {
            ...
            Duenio aux = new Duenio(0, "Pablo", 12345678, "Calle Falsa 123", new int[] { 0 });
            Duenio aux2 = new Duenio(1, "Evil Pablo", 12345678, "Calle Falsa 123", new int[] { 2, 3 });
            duenios.Agregar(aux);
            bool actual;
        ...
        public void AgregarDuenios_RecibeFalse()
        {
            ...
            Serializador<Duenio> duenios = new Serializador<Duenio>();
            Duenio aux = new Duenio(0, "Pablo", 12345678, "Calle Falsa 123", new int[] { 0 });
            Duenio aux2 = new Duenio(1, "Pablo", 12345678, "Calle Falsa 123", new int[] { 2,3 });
            duenios.Agregar(aux);
            bool actual;
